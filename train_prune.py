...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    val.run(data_dict,
           ...
           save_dir=save_dir,
           save_json=False, # is_coco and final_epoch
    ...
    if opt.Mobilenet is not None:
        model.prune_mobilenet(opt.threshold)
    else:
    ...
    torch.save(ckpt, os.path.join(save_path, 'prune.pt'))

    prune_weight = save_path + 'prune.pt' 
